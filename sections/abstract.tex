...
Miscarriage is often due to chromosomal aneuploidies of the gametes but it can also have non random genetic causes like small-size mutations, both \textit{de novo} or inherited from parents. Analysis of genomic sequences of miscarried embryos has been mostly focusing on rare variation, and carried out using criteria and methods that are difficult to reproduce. The role of small-size mutations has been scantily investigated so far.
